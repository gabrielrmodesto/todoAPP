...
describe('TodoDataService', () => {
	...
	describe('#save(todo)', () => {
		it('should automatically assign an incremating id', inject([TodoDataService],(service: TodoDataService) => {
			let todo1 = new Todo({title: 'Hello 1', complete: false});
			let todo2 = new Todo({title: 'Hello 2', complete: true});
			service.addTodo(todo1);
			service.addTodo(todo2);
	...
	describe('#updateTodoById(id,values)', () => {
		it('should return todo id with the corresponding id and update data', inject([TodoDataService], (service: TodoDataService) => {
